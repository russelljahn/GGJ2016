...
public class Cardboard : MonoBehaviour {
  ...
  /// Whether to show the onscreen analog of the (Android) Cancel Button.
  ...
  /// Unity also sees the System Cancel button as an Escape key.
  ...
  /// Emitted whenever the user presses the "VR Cancel Button".
  ...
  /// Whether the user has pressed the "VR Cancel Button", which is generally meant to toggle
